...
So, we now know how to handle optional arguments with default values, but what if we want to do something entirely different depending on the number of arguments provided ?
...
What will it look like in C ? Well it's up to you, here are a few propositions:
:::::{tab-set}
::::{tab-item} Syntax 1
```{code-block} C
